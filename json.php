<?php
  ...
  require_once("TesseractOCR/b64image.php");
  require_once('TesseractOCR/TesseractOCR.php');
  require_once('TesseractOCR/TesseractOCRHelper.php');
  
  $targetPath = "";
  
  if (strlen($_POST['b64_image']) > 0 && strlen($_POST['b64_image_name']) > 0) {
  
	$targetPath = $basepath . "upload/images/" . trim($_POST['b64_image_name']) . ".jpg";
    $b64_image = base64_to_jpeg(trim($_POST['b64_image']), $targetPath);
